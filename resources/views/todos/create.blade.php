<x-app-layout>
  ...
  <form method="post" action="{{ route('todos.store') }}" class="max-w-sm mx-auto">
    ...
    <div class="mb-3">
      <label class="block mb-2 text-sm font-large font-medium text-gray-900 dark:text-white">Category</label>
    ...
    <button type="submit" class="px-6 py-3 transition duration-150 ease-in-out bg-sky-500 hover:bg-sky-200 rounded-full">Create Todo</button>
  </form>
</x-app-layout>
